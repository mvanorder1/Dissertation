...
%TODO Write caption for image below
\begin{figure}[h]
	\centering
	\begin{subfigure}[c]{0.47\textwidth}
		\includegraphics[width=\linewidth]{hexdec-di-mica_fresh-cleave-48hrInSoln_CAcrop}
		\subcaption{~}
		\label{fig:hexdec-mica-cleave}		
	\end{subfigure}
	\begin{subfigure}[c]{0.47\textwidth} 
		\includegraphics[width=\linewidth]{hexdec-di-mica_fresh-cleave-48hrInSoln&KimWipe_CAcrop}
		\subcaption{~}
		\label{fig:hexdec-mica-wipe}		
	\end{subfigure}
